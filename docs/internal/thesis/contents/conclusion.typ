...
= Conclusion
Ce travail répond à une problématique identifiée à titre personnel: l'absence,
parmi les solutions existantes, d'un système d'exploitation alliant
déclarativité continue, intégration native de la conteneurisation et légèreté
suffisante pour des déploiements modestes. Le travail de semestre ayant précédé
...
introduction: le système démarre un conteneur en moins de 5.1 secondes
lorsqu'une image doit être téléchargée, et ne requiert que 160 Mio de mémoire
pour exécuter un serveur web minimal, un seuil sensiblement inférieur à celui
des solutions comparables. Au regard de l'ensemble de ces éléments, les
